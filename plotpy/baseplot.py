...
:py:class:`plotpy.baseplot.BasePlot`. This is an enhanced version of 
...
.. warning::
    :py:class:`plotpy.baseplot.BasePlot` is rather an internal class 
    than a ready-to-use plotting widget. The end user should prefer using 
    :py:class:`plotpy.plot.CurvePlot` or :py:class:`plotpy.plot.ImagePlot`.
...
from plotpy.interfaces import IBasePlotItem, IItemType, ISerializableType
from plotpy.styles import ItemParameters, AxeStyleParam, AxesParam, AxisParam
...
#    Y_LEFT, Y_RIGHT, X_BOTTOM, X_TOP = range(4)
    ...
    def set_manager(self, manager, plot_id):
        """Set the associated :py:class:`plotpy.plot.PlotManager` instance"""
    ...
    def save_items(self, iofile, selected=False):
        ...
        See also :py:meth:`plotpy.baseplot.BasePlot.restore_items`
        """
        if selected:
    ...
    def restore_items(self, iofile):
        ...
        See also :py:meth:`plotpy.baseplot.BasePlot.save_items`
        """
        import pickle
