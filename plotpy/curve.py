...
The `curve` module provides curve-related objects:
    * :py:class:`plotpy.curve.CurvePlot`: a 2d curve plotting widget
    * :py:class:`plotpy.curve.CurveItem`: a curve plot item
    * :py:class:`plotpy.curve.ErrorBarCurveItem`: a curve plot item with 
      error bars
    * :py:class:`plotpy.curve.GridItem`
    * :py:class:`plotpy.curve.ItemListWidget`: base widget implementing the 
      `plot item list panel`
    * :py:class:`plotpy.curve.PlotItemList`: the `plot item list panel`
...
Create a curve item:
    * from the associated plot item class (e.g. `ErrorBarCurveItem` to 
      ...
      (e.g. :py:class:`plotpy.styles.ErrorBarParam`)
...
from plotpy.panels import PanelWidget, ID_ITEMLIST
from plotpy.baseplot import BasePlot, canvas_to_axes
from plotpy.styles import GridParam, CurveParam, ErrorBarParam, SymbolParam
...
class GridItem(QwtPlotGrid):
    ...
    (see :py:class:`plotpy.styles.GridParam`)
    """
...
class CurveItem(QwtPlotCurve):
    ...
    (see :py:class:`plotpy.styles.CurveParam`)
    """
...
class ErrorBarCurveItem(CurveItem):
    ...
    (see :py:class:`plotpy.styles.ErrorBarParam`)
    """
...
class ItemListWidget(QListWidget):
    ...
    def get_selected_items(self):
        ...
        .. warning::
            ...
            :py:data:`plotpy.baseplot.BasePlot.get_selected_items`.
    ...
    def __get_item_icon(self, item):
        from plotpy.label import LegendBoxItem, LabelItem
        from plotpy.annotations import (AnnotatedShape, AnnotatedRectangle,
                                        AnnotatedCircle, AnnotatedEllipse,
                                        AnnotatedPoint, AnnotatedSegment)
        from plotpy.shapes import (SegmentShape, RectangleShape, EllipseShape,
                                   PointShape, PolygonShape, Axes,
                                   XRangeSelection)
        from plotpy.image import (BaseImageItem, Histogram2DItem,
                                  ImageFilterItem)
        from plotpy.histogram import HistogramItem
...
class CurvePlot(BasePlot):
    ...
    (this class inherits :py:class:`plotpy.baseplot.BasePlot`)
    ...
    def do_zoom_view(self, dx, dy, lock_aspect_ratio=False):
        ...
        """
        # See plotpy/events.py where dx and dy are defined like this:
    ...
    def add_item(self, item, z=None):
        ...
        Add a *plot item* instance to this *plot widget*
            ...
            * item: :py:data:`qwt.QwtPlotItem` object implementing
              the :py:data:`plotpy.interfaces.IBasePlotItem` interface
