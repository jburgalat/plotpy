...
The `shapes` module provides geometrical shapes:
    * :py:class:`plotpy.shapes.PolygonShape`
    * :py:class:`plotpy.shapes.RectangleShape`
    * :py:class:`plotpy.shapes.ObliqueRectangleShape`
    * :py:class:`plotpy.shapes.PointShape`
    * :py:class:`plotpy.shapes.SegmentShape`
    * :py:class:`plotpy.shapes.EllipseShape`
    * :py:class:`plotpy.shapes.Axes`
    * :py:class:`plotpy.shapes.XRangeSelection`

A shape is a plot item (derived from QwtPlotItem) that may be displayed 
on a 2D plotting widget like :py:class:`plotpy.curve.CurvePlot` 
or :py:class:`plotpy.image.ImagePlot`.

.. seealso:: module :py:mod:`plotpy.annotations`
...
A shape may be created:
    * from the associated plot item class (e.g. `RectangleShape` to create a 
      ...
      (:py:class:`plotpy.styles.ShapeParam`)
...
from plotpy.qt.QtGui import QPen, QBrush, QPolygonF, QTransform, QPainter
from plotpy.qt.QtCore import Qt, QRectF, QPointF, QLineF

from plotpy.utils import assert_interfaces_valid, update_dataset
from plotpy.py3compat import maxsize

# Local imports
from plotpy.transitional import QwtPlotItem, QwtSymbol, QwtPlotMarker
from plotpy.config import CONF, _
from plotpy.interfaces import IBasePlotItem, IShapeItemType, ISerializableType
from plotpy.styles import (MarkerParam, ShapeParam, RangeShapeParam,
                           AxesShapeParam, MARKERSTYLES)
from plotpy.geometry import (vector_norm, vector_projection, vector_rotation,
                             compute_center)
