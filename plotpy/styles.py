...
from plotpy.colormap import get_colormap_list, build_icon_from_cmap_name
...
class ItemParameters(object):
    ...
    def update(self, plot):
        ...
        # (see also plotpy.image.ImagePlot.edit_axis_parameters)
...
class BaseImageParam(DataSet):
    ...
    def update_param(self, image):
        ...
        from plotpy.image import INTERP_NEAREST, INTERP_LINEAR
    ...
    def update_image(self, image):
        ...
        from plotpy.image import INTERP_NEAREST, INTERP_LINEAR, INTERP_AA
        if size == 0:
            mode = INTERP_NEAREST
        elif size == 1:
            mode = INTERP_LINEAR
