...
The `histogram` module provides histogram related objects:
    * :py:class:`plotpy.histogram.HistogramItem`: an histogram plot item
    * :py:class:`plotpy.histogram.ContrastAdjustment`: the `contrast 
      adjustment panel`
    * :py:class:`plotpy.histogram.LevelsHistogram`: a curve plotting widget 
...
be displayed on a 2D plotting widget like :py:class:`plotpy.curve.CurvePlot` 
...
.. literalinclude:: /../plotpy/tests/histogram.py
...
from plotpy.panels import PanelWidget, ID_CONTRAST
from plotpy.curve import CurveItem, CurvePlot
...
from plotpy.tools import (SelectTool, BasePlotMenuTool, SelectPointTool,
                          AntiAliasingTool)
...
class HistogramItem(CurveItem):
    ...
    def set_hist_source(self, src):
        ...
        *source*:
            ...
            :py:data:`plotpy.image.ImageItem`
        """
