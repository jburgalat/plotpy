...
The `labels` module provides plot items related to labels and legends:
    * :py:class:`plotpy.shapes.LabelItem`
    * :py:class:`plotpy.shapes.LegendBoxItem`
    * :py:class:`plotpy.shapes.SelectedLegendBoxItem`
    * :py:class:`plotpy.shapes.RangeComputation`
    * :py:class:`plotpy.shapes.RangeComputation2d`
    * :py:class:`plotpy.shapes.DataInfoLabel`
...
from plotpy.styles import LabelParam
