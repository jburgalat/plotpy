...
The ``plotpy.widgets.misc`` module provides ready-to-use or generic widgets 
for developing easily Qt-based graphical user interfaces.
"""

from math import cos, sin, pi
from plotpy.qt import PYQT5
from plotpy.qt.QtGui import QLabel, QPainter, QPen, QWidget, QDockWidget
from plotpy.qt.QtCore import QSize, Qt

# Local imports:
from plotpy.configtools import get_family
