...
from plotpy.histogram import lut_range_threshold
from plotpy.image import INTERP_LINEAR, TrImageItem
from plotpy.plot import ImageWidget, ImageDialog
...
class BaseMultipleTransformWidget(QTabWidget):
    ...
    Transform several :py:class:`plotpy.image.TrImageItem` plot items"""
