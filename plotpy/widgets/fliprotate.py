...
for rotating (arbitrary angle) and cropping an image:
    ...
    * :py:class:`plotpy.widgets.fliprotate.FlipRotateDialog`: dialog box
    * :py:class:`plotpy.widgets.fliprotate.FlipRotateWidget`: equivalent widget
...
class FlipRotateDialog(base.BaseTransformDialog, FlipRotateMixin):
    ...
    Flip and rotate a :py:class:`plotpy.image.TrImageItem` plot item"""
...
class MultipleFlipRotateWidget(base.BaseMultipleTransformWidget):
    ...
    Flip and rotate several :py:class:`plotpy.image.TrImageItem` plot items"""
