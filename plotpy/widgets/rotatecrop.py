...
for rotating (arbitrary angle) and cropping an image:
    ...
    * :py:class:`plotpy.widgets.rotatecrop.RotateCropDialog`: dialog box
    * :py:class:`plotpy.widgets.rotatecrop.RotateCropWidget`: equivalent widget
...
from plotpy.image import get_image_in_shape
...
class RotateCropDialog(base.BaseTransformDialog, RotateCropMixin):
    ...
    Rotate and crop a :py:class:`plotpy.image.TrImageItem` plot item"""
...
class MultipleRotateCropWidget(base.BaseMultipleTransformWidget):
    ...
    Rotate and crop several :py:class:`plotpy.image.TrImageItem` plot items"""
