...
(factory registration is done in plotpy.dataset.qtwidgets)
(data item types are defined in plotpy.dataset.datatypes)
...
from plotpy.qt.QtGui import (QIcon, QPixmap, QHBoxLayout, QGridLayout, QColor,
...
from plotpy.qt.compat import getexistingdirectory
try:
    from plotpy.qt.QtCore import QStringList
except ImportError:
    # PyQt API#2
    QStringList = list

from plotpy.utils import update_dataset, restore_dataset, utf8_to_unicode
from plotpy.qthelpers import text_to_qcolor, get_std_icon
from plotpy.configtools import get_icon, get_image_layout, get_image_file_path
...
# (see plotpy.datatypes for details)
#
# ========================== <!> IMPORTANT <!> =================================
