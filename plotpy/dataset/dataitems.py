...
The ``plotpy.dataset.dataitems`` module contains implementation for 
concrete DataItems.
"""
...
from plotpy.dataset.datatypes import DataItem, ItemProperty
from plotpy.utils import utf8_to_unicode, add_extension
from plotpy.config import _
from plotpy.py3compat import to_text_string, is_text_string, TEXT_TYPES
...
class ColorItem(StringItem):
    ...
    def check_value(self, value):
        ...
        if not isinstance(value, self.type):
            return False
        from plotpy.qthelpers import text_to_qcolor
