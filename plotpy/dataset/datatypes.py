...
The ``plotpy.dataset.datatypes`` module contains implementation for 
...
from plotpy.utils import utf8_to_unicode, update_dataset
from plotpy.py3compat import to_text_string, is_text_string, PY2
...
class DataItemProxy(object):
    ...
    (see module plotpy.dataset.qtwidgets)
    """
...
class DataSet(Meta_Py3Compat):
    ...
    Construct a DataSet object is a set of DataItem objects
        ...
        * icon [QIcon or string]: icon show on the button (optional)
          (string: icon filename as in plotpy/guiqwt image search paths)
    """
    ...
    def text_edit(self):
        ...
        """
        from plotpy.dataset import textedit
    ...
    def edit(self, parent=None, apply=None, size=None):
        ...
        """
        from plotpy.dataset.qtwidgets import DataSetEditDialog
    ...
    def view(self, parent=None, size=None):
        ...
        Open a dialog box to view data set
            ...
            * size: dialog size (QSize object or integer tuple (width, height))
        """
        from plotpy.dataset.qtwidgets import DataSetShowDialog
    ...
    def read_config(self, conf, section, option):
        from plotpy.userconfigio import UserConfigReader 
        reader = UserConfigReader(conf, section, option)
        self.deserialize(reader)
        
    def write_config(self, conf, section, option):
        from plotpy.userconfigio import UserConfigWriter 
...
class DataSetGroup(object):
    ...
    def edit(self, parent=None, apply=None):
        ...
        Open a dialog box to edit data set
        """
        from plotpy.dataset.qtwidgets import DataSetGroupEditDialog
