...
The `plot` module provides the following features:
    ...
    * :py:class:`plotpy.plot.ImageDialog`: a ready-to-use dialog box for 
...
.. seealso::
    ...
    Module :py:mod:`plotpy.tools`
        Module providing the `plot tools`
        
    Module :py:mod:`plotpy.panels`
        Module providing the `plot panels` IDs
        
    Module :py:mod:`plotpy.baseplot`
...
.. literalinclude:: /../plotpy/tests/filtertest1.py
   :start-after: SHOW
...
.. literalinclude:: /../plotpy/tests/filtertest2.py
   :start-after: SHOW
   :end-before: Workaround for Sphinx v0.6 bug: empty 'end-before' directive
...
from plotpy.tools import (SelectTool, RectZoomTool, ColormapTool, HelpTool,
...
class PlotManager(object):
    ...
    between plots (i.e. :py:class:`plotpy.curve.CurvePlot` or 
    :py:class:`plotpy.image.ImagePlot` objects), panels, 
    tools (see :py:mod:`plotpy.tools`) and toolbars
    """
    ...
    def add_plot(self, plot, plot_id=DefaultPlotID):
        ...
        Register a plot to the plot manager:
            * plot: :py:class:`plotpy.curve.CurvePlot` or 
              :py:class:`plotpy.image.ImagePlot` object
    ...
    def get_main(self):
        ...
        :py:class:`plotpy.plot.ImageWidget` objects, this method will 
    ...
    def register_curve_tools(self):
        ...
        .. seealso::
            ...
            :py:meth:`plotpy.plot.PlotManager.add_tool`
            
            :py:meth:`plotpy.plot.PlotManager.register_standard_tools`
            
            :py:meth:`plotpy.plot.PlotManager.register_other_tools`
            
            :py:meth:`plotpy.plot.PlotManager.register_image_tools`
        """
    ...
    def register_image_tools(self):
        ...
        .. seealso::
            ...
            :py:meth:`plotpy.plot.PlotManager.register_curve_tools`
        """
    ...
    def register_all_curve_tools(self):
        ...
        .. seealso::
            ...
            :py:meth:`plotpy.plot.PlotManager.register_all_image_tools`
        """
    ...
    def register_all_image_tools(self):
        ...
        .. seealso::
            ...
            :py:meth:`plotpy.plot.PlotManager.register_all_curve_tools`
        """
        self.register_standard_tools()
        self.add_separator_tool()
...
class BaseCurveWidget(QSplitter):
    ...
    Construct a BaseCurveWidget object, which includes:
        * A plot (:py:class:`plotpy.curve.CurvePlot`)
        * An `item list` panel (:py:class:`plotpy.curve.PlotItemList`)
        
    This object does nothing in itself because plot and panels are not 
    connected to each other.
    See children class :py:class:`plotpy.plot.CurveWidget`
    """
...
class BaseImageWidget(QSplitter):
    ...
    Construct a BaseImageWidget object, which includes:
        ...
        * A `contrast adjustment` panel 
          (:py:class:`plotpy.histogram.ContrastAdjustment`)
        * An `X-axis cross section` panel
          (:py:class:`plotpy.histogram.XCrossSection`)
        * An `Y-axis cross section` panel
          (:py:class:`plotpy.histogram.YCrossSection`)
        
    This object does nothing in itself because plot and panels are not 
    connected to each other.
    See children class :py:class:`plotpy.plot.ImageWidget`
    """
...
class ImageWidgetMixin(CurveWidgetMixin):
    def register_tools(self):
        ...
        this method is exactly the same as calling 
        :py:meth:`plotpy.plot.CurveDialog.register_all_image_tools`
    ...
    def create_plot(self, options, row=0, column=0, rowspan=1, columnspan=1):
        """
        Create the plotting widget (which is an instance of class 
        :py:class:`plotpy.plot.BaseImageWidget`), add it to the dialog box 
        main layout (:py:attr:`plotpy.plot.CurveDialog.plot_layout`) and 
...
class ImageDialog(CurveDialog, ImageWidgetMixin):
    ...
    plot manager
        ...
        * edit: editable state
        * toolbar: show/hide toolbar
        * options: options sent to the :py:class:`plotpy.image.ImagePlot` object
          (dictionary)
        * parent: parent widget
        * panels (optional): additionnal panels (list, tuple)
    """
