...
The `qtdesigner` module provides QtDesigner helper functions for `plotpy`:
    * :py:func:`plotpy.qtdesigner.loadui`
    * :py:func:`plotpy.qtdesigner.compileui`
    * :py:func:`plotpy.qtdesigner.create_qtdesigner_plugins`
...
def loadui(fname, replace_class="QwtPlot"):
    ...
    The loadUiType function (PyQt4.uic) doesn't work correctly with plotpy
...
def create_qtdesigner_plugin(group, module_name, class_name, widget_options={},
    ...
    Example:
    create_qtdesigner_plugin(group = "plotpy", module_name = "plotpy.image",
