...
The ``plotpy.configtools`` module provides configuration related tools.
"""
...
from plotpy.qt.QtGui import (QFont, QLabel, QPixmap, QIcon, QHBoxLayout,
                              QColor, QPen, QBrush, QFontDatabase)
from plotpy.qt.QtCore import Qt

from plotpy.utils import get_module_path, decode_fs_string

from plotpy.py3compat import is_unicode, to_text_string, PY3, is_text_string
