...
(see plotpy.hdf5io for another example of reader/writer)
"""

import collections
import datetime

from plotpy.py3compat import is_unicode, PY3
...
class BaseIOHandler(object):
    ...
    (see plotpy.hdf5io for another example of this handler usage)"""
    def __init__(self):
        self.option = []
