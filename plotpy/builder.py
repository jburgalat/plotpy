...
from plotpy.curve import CurveItem, ErrorBarCurveItem, GridItem
from plotpy.histogram import HistogramItem, lut_range_threshold
from plotpy.image import (ImageItem, QuadGridItem, TrImageItem, XYImageItem,
                          Histogram2DItem, RGBImageItem, MaskedImageItem)
from plotpy.shapes import (XRangeSelection, RectangleShape, EllipseShape,
                           SegmentShape, Marker)
from plotpy.annotations import (AnnotatedRectangle, AnnotatedEllipse,
                                AnnotatedSegment)
from plotpy.styles import (update_style_attr, CurveParam, ErrorBarParam,
...
from plotpy.label import (LabelItem, LegendBoxItem, RangeComputation,
...
class PlotItemBuilder(object):
    ...
    def __set_baseparam(self, param, color, linestyle, linewidth,
        ...
        """Apply parameters to a `plotpy.styles.CurveParam` or 
        `plotpy.styles.MarkerParam` instance"""
    ...
    def __set_param(self, param, title, color, linestyle, linewidth, marker,
                    ...
                    curvestyle, baseline):
        """Apply parameters to a `plotpy.styles.CurveParam` instance"""
    ...
    def mcurve(self, *args, **kwargs):
        ...
        (:py:class:`plotpy.curve.CurveItem` object)
    ...
    def pcurve(self, x, y, param, xaxis="bottom", yaxis="left"):
        ...
        based on a `plotpy.styles.CurveParam` instance
        (:py:class:`plotpy.curve.CurveItem` object)
    ...
    def merror(self, *args, **kwargs):
        ...
        (:py:class:`plotpy.curve.ErrorBarCurveItem` object)
    ...
    def perror(self, x, y, dx, dy, curveparam, errorbarparam,
        ...
        based on a `plotpy.styles.ErrorBarParam` instance
        (:py:class:`plotpy.curve.ErrorBarCurveItem` object)
    ...
    def histogram(self, data, bins=None, logscale=None,
        ...
        (:py:class:`plotpy.histogram.HistogramItem` object)
    ...
    def phistogram(self, data, curveparam, histparam,
        ...
        Make 1D histogram `plot item` 
        (:py:class:`plotpy.histogram.HistogramItem` object) 
        based on a `plotpy.styles.CurveParam` and 
        `plotpy.styles.HistogramParam` instances
    ...
    def image(self, data=None, filename=None, title=None, alpha_mask=None,
        ...
        (:py:class:`plotpy.image.ImageItem` object or 
        :py:class:`plotpy.image.RGBImageItem` object if data has 3 dimensions)
        """
    ...
    def maskedimage(self, data=None, mask=None, filename=None, title=None,
        ...
        (:py:class:`plotpy.image.MaskedImageItem` object)
        """
        assert isinstance(xdata, (tuple, list)) and len(xdata) == 2
        assert isinstance(ydata, (tuple, list)) and len(ydata) == 2
    ...
    def rgbimage(self, data=None, filename=None, title=None,
        ...
        (:py:class:`plotpy.image.RGBImageItem` object)
        """
        assert isinstance(xdata, (tuple, list)) and len(xdata) == 2
        assert isinstance(ydata, (tuple, list)) and len(ydata) == 2
    ...
    def quadgrid(self, X, Y, Z, filename=None, title=None, alpha_mask=None,
        ...
        (:py:class:`plotpy.image.QuadGridItem` object)
        """
    ...
    def trimage(self, data=None, filename=None, title=None, alpha_mask=None,
        ...
        affine transform)
        (:py:class:`plotpy.image.TrImageItem` object)
    ...
    def xyimage(self, x, y, data, title=None, alpha_mask=None, alpha=None,
        ...
        (:py:class:`plotpy.image.XYImageItem` object)
    ...
    def imagefilter(self, xmin, xmax, ymin, ymax,
        ...
        (:py:class:`plotpy.image.ImageFilterItem` object)
    ...
    def histogram2D(self, X, Y, NX=None, NY=None, logscale=None,
        ...
        (:py:class:`plotpy.image.Histogram2DItem` object)
    ...
    def label(self, text, g, c, anchor, title=""):
        ...
        (:py:class:`plotpy.label.LabelItem` object)
    ...
    def legend(self, anchor='TR', c=None, restrict_items=None):
        ...
        (:py:class:`plotpy.label.LegendBoxItem` or 
        :py:class:`plotpy.label.SelectedLegendBoxItem` object)
    ...
    def vcursor(self, x, label=None, constraint_cb=None,
        ...
        (:py:class:`plotpy.shapes.Marker` object)
        """
        if label is None:
            label_cb = lambda x, y: ''
        else:
    ...
    def rectangle(self, x0, y0, x1, y1, title=None):
        ...
        (:py:class:`plotpy.shapes.RectangleShape` object)
    ...
    def ellipse(self, x0, y0, x1, y1, title=None):
        ...
        (:py:class:`plotpy.shapes.EllipseShape` object)
    ...
    def segment(self, x0, y0, x1, y1, title=None):
        ...
        (:py:class:`plotpy.shapes.SegmentShape` object)
    ...
    def annotated_rectangle(self, x0, y0, x1, y1, title=None, subtitle=None):
        ...
        (:py:class:`plotpy.annotations.AnnotatedRectangle` object)
    ...
    def annotated_ellipse(self, x0, y0, x1, y1, ratio,
        ...
        (:py:class:`plotpy.annotations.AnnotatedEllipse` object)
    ...
    def annotated_circle(self, x0, y0, x1, y1, ratio,
        ...
        (:py:class:`plotpy.annotations.AnnotatedCircle` object)
    ...
    def annotated_segment(self, x0, y0, x1, y1, title=None, subtitle=None):
        ...
        (:py:class:`plotpy.annotations.AnnotatedSegment` object)
    ...
    def computation2d(self, rect, anchor, label, image, function, title=None):
        ...
        (:py:class:`plotpy.label.RangeComputation2d` object)
        (see example: :py:mod:`plotpy.tests.computations`)
        """
