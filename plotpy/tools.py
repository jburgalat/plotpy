...
The `tools` module provides a collection of `plot tools` :
    * :py:class:`plotpy.tools.RectZoomTool`
    * :py:class:`plotpy.tools.SelectTool`
    * :py:class:`plotpy.tools.SelectPointTool`
    * :py:class:`plotpy.tools.MultiLineTool`
    * :py:class:`plotpy.tools.FreeFormTool`
    * :py:class:`plotpy.tools.LabelTool`
    * :py:class:`plotpy.tools.RectangleTool`
    * :py:class:`plotpy.tools.PointTool`
    * :py:class:`plotpy.tools.SegmentTool`
    * :py:class:`plotpy.tools.CircleTool`
    * :py:class:`plotpy.tools.EllipseTool`
    * :py:class:`plotpy.tools.PlaceAxesTool`
    * :py:class:`plotpy.tools.AnnotatedRectangleTool`
    * :py:class:`plotpy.tools.AnnotatedCircleTool`
    * :py:class:`plotpy.tools.AnnotatedEllipseTool`
    * :py:class:`plotpy.tools.AnnotatedPointTool`
    * :py:class:`plotpy.tools.AnnotatedSegmentTool`
    * :py:class:`plotpy.tools.HRangeTool`
    * :py:class:`plotpy.tools.DummySeparatorTool`
    * :py:class:`plotpy.tools.AntiAliasingTool`
    * :py:class:`plotpy.tools.DisplayCoordsTool`
    * :py:class:`plotpy.tools.ReverseYAxisTool`
    * :py:class:`plotpy.tools.AspectRatioTool`
    * :py:class:`plotpy.tools.PanelTool`
    * :py:class:`plotpy.tools.ItemListPanelTool`
    * :py:class:`plotpy.tools.ContrastPanelTool`
    * :py:class:`plotpy.tools.ColormapTool`
    * :py:class:`plotpy.tools.XCSPanelTool`
    * :py:class:`plotpy.tools.YCSPanelTool`
    * :py:class:`plotpy.tools.CrossSectionTool`
    * :py:class:`plotpy.tools.AverageCrossSectionTool`
    * :py:class:`plotpy.tools.SaveAsTool`
    * :py:class:`plotpy.tools.CopyToClipboardTool`
    * :py:class:`plotpy.tools.OpenFileTool`
    * :py:class:`plotpy.tools.OpenImageTool`
    * :py:class:`plotpy.tools.SnapshotTool`
    * :py:class:`plotpy.tools.PrintTool`
    * :py:class:`plotpy.tools.SaveItemsTool`
    * :py:class:`plotpy.tools.LoadItemsTool`
    * :py:class:`plotpy.tools.AxisScaleTool`
    * :py:class:`plotpy.tools.HelpTool`
    * :py:class:`plotpy.tools.ExportItemDataTool`
    * :py:class:`plotpy.tools.EditItemDataTool`
    * :py:class:`plotpy.tools.ItemCenterTool`
    * :py:class:`plotpy.tools.DeleteItemTool`

A `plot tool` is an object providing various features to a plotting widget 
(:py:class:`plotpy.curve.CurvePlot` or :py:class:`plotpy.image.ImagePlot`): 
...
i.e. an instance of the :py:class:`plotpy.plot.PlotManager` class (see 
the :py:mod:`plotpy.plot` module for more details on the procedure).
...
:py:class:`plotpy.plot.CurveWidget` and :py:class:`plotpy.plot.ImageWidget`
...
from plotpy.shapes import (Axes, RectangleShape, Marker, PolygonShape,
                           EllipseShape, SegmentShape, PointShape,
                           ObliqueRectangleShape)
from plotpy.annotations import (AnnotatedRectangle, AnnotatedCircle,
                                AnnotatedEllipse, AnnotatedSegment,
                                AnnotatedPoint, AnnotatedObliqueRectangle)
from plotpy.colormap import get_colormap_list, get_cmap, build_icon_from_cmap
from plotpy.interfaces import (IColormapImageItemType, IPlotManager,
                               IVoiImageItemType, IStatsImageItemType,
                               ICurveItemType)
from plotpy.panels import ID_XCS, ID_YCS, ID_OCS, ID_ITEMLIST, ID_CONTRAST
...
class HRangeTool(BaseCursorTool):
    ...
    ICON = "xrange.png"
    def create_shape(self):
        from plotpy.shapes import XRangeSelection
...
class VCursorTool(BaseCursorTool):
    ...
    ICON = "vcursor.png"
    def create_shape(self):
        from plotpy.shapes import Marker
        marker = Marker()
...
class BasePlotMenuTool(CommandTool):
    ...
    def __init__(self, manager, key, title=None,
        ...
        from plotpy.baseplot import PARAMETERS_TITLE_ICON
...
def save_snapshot(plot, p0, p1, new_size=None):
    ...
    """
    from plotpy.image import (get_image_from_plot, get_plot_qrect,
...
class RotateCropTool(CommandTool):
    ...
    See :py:class:`plotpy.rotatecrop.RotateCropDialog` dialog."""
    ...
    def activate_command(self, plot, checked):
        """Activate tool"""
        from plotpy.image import TrImageItem
...
class AboutTool(CommandTool):
    def __init__(self, manager, toolbar_id=DefaultToolbarID):
        super(AboutTool, self).__init__(manager, _("About")+" plotpy",
                                        get_icon("plotpy.svg"),
                                        toolbar_id=None)
...
class ItemManipulationBaseTool(CommandTool):
    ...
    def get_supported_items(self, plot):
        ...
        from plotpy.image import ImageItem
...
class ItemCenterTool(CommandTool):
    ...
    def get_supported_items(self, plot):
        from plotpy.shapes import (RectangleShape, EllipseShape,
                                   ObliqueRectangleShape)
        from plotpy.annotations import (AnnotatedRectangle, AnnotatedEllipse,
...
class ImageMaskTool(CommandTool):
    ...
    def find_masked_image(self, plot):
        item = plot.get_active_item()
        from plotpy.image import MaskedImageItem
