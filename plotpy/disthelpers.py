...
The ``plotpy.disthelpers`` module provides helper functions for Python 
...
# Local imports
from plotpy.configtools import get_module_path
from plotpy.py3compat import to_binary_string
    ...
    def add_modules(self, *module_names):
        ...
        for module_name in module_names:
            ...
            if module_name in ('PyQt4', 'PyQt5'):
                ...
                self.add_module_data_files('plotpy', ("images", ),
                ...
                try:
                    # Modules based on the same scheme as plotpy and guiqwt
